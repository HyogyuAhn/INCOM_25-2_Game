...
class ColorGameOverScreen(game: ClubGame, private val finalScore: Int) : BaseScreen(game) {
    override fun setupUI() {
        ...
        val retryBtn = com.club.ui.UIComponents.createModernButton("다시하기", game.font) {
            game.router.goTo(ScreenId.COLOR)
        }
        val menuBtn = com.club.ui.UIComponents.createModernButton("메인 메뉴", game.font) {
